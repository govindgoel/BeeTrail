...
const ReviewSubmittedModal = ({visible, onCancel}) => {
    ...
    <Modal
      ...
      <View style={styles.container}>
        <View style={styles.alertBox}>
            ...
            <Image source={require('../../../assets/images/Cross.png')} style={{width:25,height:25}}/>
            </TouchableOpacity>
           
            <Image source={require('../../../assets/images/reviewOk.png')} style={{marginBottom:20}}/>
            <CustomText style={styles.reviewText} type='mlabel'>{t('reviewSubmitted')}</CustomText>
